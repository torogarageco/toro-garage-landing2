        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12 mb-14">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center gap-3 mb-5">
              <div className="w-12 h-12 bg-[#c94a0c] rounded-xl flex items-center justify-center shadow-lg shadow-orange-900/20 flex-shrink-0">
                <span
              ...
              <div>
                <div
                  className="text-white font-black text-2xl tracking-[0.15em] leading-none"
                  style={{ fontFamily: "var(--font-heading)" }}
                >
                  TORO
                </div>
                <div
                  className="text-[#c94a0c] font-bold text-[10px] tracking-[0.4em] leading-none mt-1"
                  style={{ fontFamily: "var(--font-heading)" }}
                >
                  GARAGE CO.
                </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <span className="text-sm">
                  Serving San Antonio · Texas Hill Country · South Texas
                </span>
              </div>
            </div>
          </div>
          ...
          <div>
            <h4
              className="text-white font-black uppercase tracking-[0.2em] text-xs mb-5"
              style={{ fontFamily: "var(--font-heading)" }}
            >
              Services
            </h4>
          ...
          <div>
            ...
            <div className="mt-8">
              <a
                href="#contact"
                className="block text-center bg-[#c94a0c] hover:bg-[#e05c1a] text-white font-black text-xs py-3 px-5 rounded-xl uppercase tracking-[0.15em] shadow-lg shadow-orange-900/20 transition-all hover:scale-105"
                style={{ fontFamily: "var(--font-heading)" }}
              >
                Get Free Quote →
              </a>
